				...
				<Col>
					...
					<Card bg="light" text="dark">	
						<Card.Body>
							...
							<Pagination aria-label="Story pagination" className="pt-4 mb-0" data-intro="Only a certain number of stories are shown at once. Use these buttons to see more." data-step="2">
								{first_link && 
